...
<div class="form-container">
    ...
    <a href="dashboard_tamu.php" class="btn-kembali">
...
function konfirmasiData() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // Kirim form secara AJAX agar bisa tampil popup sebelum redirect
            ...
            .then(() => {
                Swal.fire({
                    ...
                    window.location.href = "dashboard_tamu.php";
                });
            })
            .catch(() => {
                Swal.fire({
