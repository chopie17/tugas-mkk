...
$tamu_terakhir = mysqli_query($koneksi, "SELECT * FROM tamu ORDER BY id DESC LIMIT 1");
$tamu = mysqli_fetch_assoc($tamu_terakhir);

// --- Ambil data grafik per bulan berdasarkan tahun filter ---
...
<div class="container">
    ...
    <div class="text-center mb-4">
        <form method="GET" action="" class="d-inline-block">
            <div class="input-group">
                <label class="input-group-text fw-bold" for="tahun">Tahun</label>
    ...
    <div class="text-center">
        <a href="../admin/dashboard.php" class="btn btn-secondary btn-custom me-2">⬅️ Kembali</a>
